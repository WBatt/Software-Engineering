	...
	if(req.query.username){
		...
		if(User.length != 0){
			if(err)
				...
				if(req.body.allergic_to_milk)//upate allergy to milk
					user.allergic_to_milk = req.body.allergic_to_milk;

				if(req.body.allergic_to_eggs)//upate allergy to eggs
					user.allergic_to_eggs = req.body.allergic_to_eggs;

				if(req.body.allergic_to_fish)//upate allergy to fish
					user.allergic_to_fish = req.body.allergic_to_fish;

				if(req.body.allergic_to_shellfish)//upate allergy to shellfish
					user.allergic_to_shellfish = req.body.allergic_to_shellfish;

				if(req.body.allergic_to_tree_nuts)//upate allergy to tree nuts
					user.allergic_to_tree_nuts = req.body.allergic_to_tree_nuts;

				if(req.body.allergic_to_peanuts)//upate allergy to peanuts
					user.allergic_to_peanuts = req.body.allergic_to_peanuts;

				if(req.body.allergic_to_wheat)//upate allergy to wheat
					user.allergic_to_wheat = req.body.allergic_to_wheat;

				if(req.body.allergic_to_soybeans)//upate allergy to soybeans
					user.allergic_to_soybeans = req.body.allergic_to_soybeans;

				if(req.body.allergic_to_gluten)//upate allergy to gluten
